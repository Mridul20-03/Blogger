    ...
    <div className="max-w-2xl mx-auto w-full p-3">
      ...
      {currentUser && (
        ...
        >
          ...
          {commentError && <Alert color="failure" className="mt-5"></Alert>}
        </form>
      )}
          ...
          <Modal.Header />
            <Modal.Body>
              <div className="text-center">
                ...
                <h3 className="mb-5 text-lg text-gray-700 dark:text-gray-300"> Are you sure you want to delete this comment? </h3>
